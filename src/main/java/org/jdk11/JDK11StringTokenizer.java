 ...
 */
public
class JDK11StringTokenizer implements Enumeration<Object> {
     ...
     */
    public JDK11StringTokenizer(String str, String delim, boolean returnDelims) {
        currentPosition = 0;
        newPosition = -1;
        delimsChanged = false;
        this.str = str;
     ...
     * @exception NullPointerException if str is {@code null}
     */
    public JDK11StringTokenizer(String str, String delim) {
     ...
     * @exception NullPointerException if str is {@code null}
     */
    public JDK11StringTokenizer(String str) {
        this(str, " \t\n\r\f", false);
    }
